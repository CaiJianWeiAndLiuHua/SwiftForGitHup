...
+ (DCPicScrollView *)picScrollViewWithFrame:(CGRect)frame WithImageUrls:(NSArray *)imageUrl {
    return  [[DCPicScrollView alloc] initWithFrame:frame WithImageNames:imageUrl];
}

- (DCPicScrollView *)initWithFrame:(CGRect)frame WithImageNames:(NSArray<NSString *> *)ImageName {
